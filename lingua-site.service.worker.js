...
/** @type {string} */
const CACHE_VERSION = '1770806559|3619205565';
/** @type {string} */
const CACHE_PREFIX = 'lingua-app-sw-cache-';
const CACHE_NAME = CACHE_PREFIX + CACHE_VERSION;
/** @type {string} */
const OFFLINE_URL = 'lingua-site.offline.html';
/** @type {boolean} */
const ENSURE_CROSSORIGIN_ISOLATION_HEADERS = true;
// Files that will be cached on load.
/** @type {string[]} */
const CACHED_FILES = ["lingua-site.html","lingua-site.js","lingua-site.offline.html","lingua-site.icon.png","lingua-site.apple-touch-icon.png","lingua-site.audio.worklet.js","lingua-site.audio.position.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHEABLE_FILES = ["lingua-site.wasm","lingua-site.pck","lingua-site.side.wasm"];
